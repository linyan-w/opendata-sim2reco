...
with 64 steps) for the 11 Tier 1 variables, conditioned on the embedding, the Tier 0 flags and the prong
multiplicity. Internally the muon is generated as $\log(P_\mathrm{reco}/P_\mathrm{true})$ and two slope
differences, the vertex as a residual, energies as $\log(E+1)$ with exact zeros dequantised into a negative
band; all robustly standardised and clipped at $\pm 12\sigma$. The model has 1.5\,M parameters and is trained
jointly on all four losses.
